...
app.post("/submit", (req, res) => {
  ...
  let random1 = Math.round(Math.random() * adj.length);
  let random2 = Math.round(Math.random() * noun.length);
  let random = `${adj[random1]} ${noun[random2]}`;
  
  res.render('index.ejs', {randomband: random});
